...
BASE_DATA = 'dataset'                                                        #'/home/gopalknookula/Adversarial-Patch-Training/kaggle_gtsrb'              #'/BS/srao/work/AP/data/'

# Base directory for experiments (model and perturbation files)
BASE_EXPERIMENTS = '/home/gopalknookula/Adversarial-Patch-Training/experiments'  #'/BS/srao/work/AP/ril-adversarial-patches-final/experiments/'

# Base directory for logs (e.g. Tensorboard)
BASE_LOGS = 'logs'                                                               # "home/gopalknookula/Adversarial-Patch-Training"                      # '/BS/srao/work/AP/ril-adversarial-patches-final/logs/'
...
def experiment_file(name, ext='.pt'):   #.pt added into the extension
    """
    ...
    return os.path.join(BASE_EXPERIMENTS, name)  #+ ext
